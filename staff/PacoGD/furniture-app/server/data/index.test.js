...
describe('models (User)', () => {
    ...
    describe('create user)', () => {
        it('it should succeed', () => {
            ...
            const item = new Item({ title: 'Super sofa', image: 'url', description: 'lorem ipsum', color: 'blue', stock: 1, price: 100 })
            const order = new Order({ deliveryAdress: 'Roc boronat', creditCard: 1234567890 })
